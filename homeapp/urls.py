...
urlpatterns = [
    ...
    path('device/<str:device_type>/<int:id>/update-temperature/', views.update_device_temperature,
         name='update_device_temperature'),
...
path('device/<str:device_type>/<int:id>/toggle_charger/', views.toggle_charger, name='toggle_charger'),
